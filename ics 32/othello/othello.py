...
class Piece(Enum):
    ...
    def is_playable_piece(piece)->bool:
        '''
        Returns if this is a playable piece or not
        '''
...
class Othello:
    ...
    def __init__(self, rows: int, cols: int, white_starts: bool, classical_board: bool, most_wins: bool):
        '''
        Sets up the game with the provided initial conditions:
            ...
            classical_board - true: white starts in the top left
        ...
        '''
        self.board = Board(rows, cols, classical_board)
    ...
    def make_move(self, row: int, col: int)->None:
        ...
        '''
        if self.game_over():
            raise InvalidMoveException("Game Over")
...
class Board:
    ...
    '''
    def __init__(self, rows: int, cols: int, classical_board: bool):
        ...
        self.classical_board = classical_board
    ...
    def _init_board(self)->None:
        ...
        white = Piece.WHITE if self.classical_board else Piece.BLACK
        black = ~white
