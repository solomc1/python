...
class NameDialog:
    def __init__(self):
        ...
        # of an application.  It's the window.
...
# the widget looks.  In our case, we use a tkinter.StringVar (a control
# variable whose value is a string) to represent the text in a Label
# widget, so that any change to the value of the StringVar will automatically
# and correspondingly make the Label's text change.  (This is an example of
# a general technique called "data binding".)
