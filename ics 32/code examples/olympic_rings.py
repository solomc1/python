...
class OlympicsRingsApplication:
    ...
    def _draw_ring(self, frac_x1: float, frac_y1: float, frac_x2: float, frac_y2: float) -> None:
        ...
        # coordinates from fractional to absolute in order to draw the oval,
        # since Canvas' create_oval() method expects absolute (pixel)
        # coordinates.  We can do that by multiplying the fractional coordinate
...
if __name__ == '__main__':
    ...
    app = OlympicsRingsApplication(rings)
    app.start()
